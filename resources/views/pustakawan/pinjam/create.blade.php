...
<div class="container">
    ...
    <form action="{{ route('peminjaman.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="pinjam" placeholder="Pinjam">
        </div>
        @error('pinjam')
            <small style="color: red">{{ $message }}</small>
        @enderror
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="kembali_asli" placeholder="Kembali Asli">
        </div>
        @error('kembali_asli')
            <small style="color: red">{{ $message }}</small>
        @enderror
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="telat" placeholder="Telat">
        </div>
        @error('telat')
            <small style="color: red">{{ $message }}</small>
        @enderror
